...
import 'package:e_commerce_app/widgets/custom_app_button.dart';
...
class EditShippingAddress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: _editShippingAppbar(context),
      body: Padding(
  ...
  _editShippingAppbar(context) {
    return appBar(
      context: context,
      text: AppString.text_edit_shpping_address.tr,
      argumentVal: true,
